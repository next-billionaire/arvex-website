      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex lg:grid lg:grid-cols-4 gap-6 overflow-x-auto pb-4">
          ...
          {services.map((s, i) => (
            <div
              key={i}
              className="min-w-[260px] lg:min-w-0 bg-white p-8 rounded-2xl border flex flex-col transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-2xl"
            >
              ...
              <button
                ...
                className="mt-6 py-3 rounded-xl font-medium bg-primary text-white transition-all duration-300 hover:scale-105 hover:-translate-y-1 hover:shadow-xl active:scale-95"
              >
                Get Quote →
              </button>
